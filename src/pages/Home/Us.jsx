...
const Us = () => {
    return (
        <div className='mx-auto border-3 relative z-10 mt-80 max-md:text-center'>
            <h2 className='text-[#878787] text-lg uppercase tracking-widest'>We are Læraðr</h2>
            <h2 className='font-normal text-5xl mb-11'><span className='font-black'>No.1</span> Events Management </h2>
